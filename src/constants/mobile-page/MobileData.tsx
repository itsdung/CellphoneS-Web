...
export const mobileData: mobileData[] = [
    {
      ...
      },
      {
        ...
        type: 'Android',
        special: ['Hỗ trợ 5G', 'Bảo mật vân tay'],
    ...
    },
    {
        ...
        chip: 'Apple A',
        type: 'Iphone(IOS)',
        special: ['Nhận diện khuôn mặt','Bảo mật vân tay'],
        manufacturer: 'Apple',
    },
    {
        id: uuidv4(),
    ...
    },
    {
        ...
        chip: 'Apple A',
        type: 'Iphone(IOS)',
        special: ['Điện thoại AI', 'Bảo mật vân tay', 'Hỗ trợ 5G', 'Sạc không dây', 'Kháng nước, kháng bụi', 'Nhận diện khuôn mặt', 'Đi kèm bút cảm ứng'],
        manufacturer: 'Apple',
        available: true,
    },
    {
        ...
        chip: 'Apple A',
        type: 'Iphone(IOS)',
        special: ['Điện thoại AI', 'Bảo mật vân tay', 'Hỗ trợ 5G', 'Sạc không dây', 'Kháng nước, kháng bụi', 'Nhận diện khuôn mặt'],
        manufacturer: 'Apple',
    },
    {
        id: uuidv4(),
        ...
        chip: 'Apple A',
        type: 'IPhone(IOS)',
        special: ['Bảo mật vân tay', 'Hỗ trợ 5G', 'Sạc không dây', 'Kháng nước, kháng bụi', 'Đi kèm bút cảm ứng'],
        manufacturer: 'Apple',
    },
    {
        id: uuidv4(),
        ...
        chip: 'Apple A',
        type: 'Iphone(IOS)',
        special: ['Điện thoại AI', 'Bảo mật vân tay', 'Hỗ trợ 5G', 'Nhận diện khuôn mặt', 'Đi kèm bút cảm ứng'],
        manufacturer: 'Apple',
        available: true,
    },
    {
        ...
        chip: 'Apple A',
        type: 'Iphone(IOS)',
        special: ['Điện thoại AI', 'Sạc không dây', 'Nhận diện khuôn mặt', 'Đi kèm bút cảm ứng'],
        manufacturer: 'Apple',
        available: true,
    },
    {
    ...
    },
    {
        ...
        chip: 'Unisoc',
        type: 'Android',
        special: ['Điện thoại AI', 'Bảo mật vân tay', 'Hỗ trợ 5G', 'Sạc không dây'],
    ...
    },
    {
        ...
        chip: 'Unisoc',
        type: 'Android',
        special: ['Nhận diện khuôn mặt', 'Hỗ trợ 5G'],
        manufacturer: 'Nokia',
        available: true,
    },
    {
        ...
        chip: 'Unisoc',
        type: 'Android',
        special: ['Điện thoại AI', 'Bảo mật vân tay', 'Hỗ trợ 5G'],
        manufacturer: 'Nokia',
    },
    {
        id: uuidv4(),
    ...
    },
    {
        ...
        chip: 'Mediatek Helio',
        type: 'Android',
        special: ['Bảo mật vân tay', 'Hỗ trợ 5G', 'Sạc không dây',  'Nhận diện khuôn mặt'],
        manufacturer: 'Oppo',
    },
    {
        id: uuidv4(),
        ...
        chip: 'Mediatek Helio',
        type: 'Android',
        special: ['Điện thoại AI', 'Bảo mật vân tay', 'Hỗ trợ 5G', 'Sạc không dây','Nhận diện khuôn mặt'],
        manufacturer: 'Oppo',
    },
    {
        id: uuidv4(),
        ...
        chip: 'Mediatek Helio',
        type: 'Android',
        special: ['Điện thoại AI', 'Hỗ trợ 5G', 'Sạc không dây', 'Nhận diện khuôn mặt'],
        manufacturer: 'Oppo',
    },
    {
        id: uuidv4(),
        ...
        chip: 'Snapdragon',
        type: 'Android',
        special: ['Bảo mật vân tay', 'Hỗ trợ 5G', 'Nhận diện khuôn mặt'],
        manufacturer: 'Xiaomi',
    },
    {
        id: uuidv4(),
    ...
    },
    {
        ...
        chip: 'Mediatek Dimensity',
        type: 'Android',
        special: ['Hỗ trợ 5G', 'Sạc không dây'],
        manufacturer: 'realme',
    },
    {
        id: uuidv4(),
    ...
    },
    {
        ...
        chip: 'Exynos',
        type: 'Android',
        special: ['Điện thoại AI', 'Bảo mật vân tay', 'Hỗ trợ 5G', 'Nhận diện khuôn mặt'],
    ...
    },
    {
        ...
        chip: 'Exynos',
        type: 'Android',
        special: ['Bảo mật vân tay', 'Hỗ trợ 5G', 'Sạc không dây', 'Kháng nước, kháng bụi', 'Nhận diện khuôn mặt'],
        manufacturer: 'Samsung',
    },
    {
        id: uuidv4(),
    ...
    },
    {
        ...
        chip: 'Mediatek Dimensity',
        type: 'Android',
        special: ['Điện thoại AI', 'Bảo mật vân tay', 'Kháng nước, kháng bụi'],
        manufacturer: 'Samsung',
    },
    {
        id: uuidv4(),
    ...
    },
    {
        ...
        chip: 'Mediatek Helio',
        type: 'Android',
        special: ['Điện thoại AI', 'Bảo mật vân tay', 'Hỗ trợ 5G', 'Kháng nước, kháng bụi', 'Nhận diện khuôn mặt'],
        manufacturer: 'Sony',
    },
    {
        id: uuidv4(),
        ...
        chip: 'Mediatek Helio',
        type: 'Android',
        special: ['Bảo mật vân tay', 'Hỗ trợ 5G'],
        manufacturer: 'vivo',
    },
    {
        id: uuidv4(),
        ...
        chip: 'Mediatek Dimensity',
        type: 'Android',
        special: ['Hỗ trợ 5G', 'Sạc không dây', 'Kháng nước, kháng bụi'],
        manufacturer: 'vivo',
    },
    {
        id: uuidv4(),
    ...
    },
    {
        ...
        chip: 'Snapdragon',
        type: 'Android',
        special: ['Điện thoại AI', 'Sạc không dây', 'Nhận diện khuôn mặt'],
        manufacturer: 'Xiaomi',
    },
    {
        id: uuidv4(),
        ...
        chip: 'Snapdragon',
        type: 'Android',
        special: ['Điện thoại AI', 'Sạc không dây', 'Kháng nước, kháng bụi', 'Nhận diện khuôn mặt'],
        manufacturer: 'Xiaomi',
    },
    {
        id: uuidv4(),
    ...
    },
    {
        ...
        chip: 'Unisoc',
        type: 'Android',
        special: ['Bảo mật vân tay', 'Hỗ trợ 5G', 'Sạc không dây'],
        manufacturer: 'ZTE',
        available: true,
    },
]